...
import { Package, Paintbrush, FileText, CreditCard, Truck, ShieldCheck, Download, Globe, BarChart3, Users, Factory } from "lucide-react";
import bulkImg from "@/assets/category-bulk.jpg";

import { getWholesaleTiers, getB2BStats } from "@/lib/mockStore";

const Wholesale = () => {
  const tiers = getWholesaleTiers();
  const stats = getB2BStats();
    ...
    <>
      ...
      <div className="bg-white border-b border-secondary/20">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-0 divide-x divide-secondary/20 border-x border-secondary/20">
            {stats.map((stat, i) => (
