...
export const getB2BStats = () => {
    const saved = localStorage.getItem("abaseen_b2b_stats");
    if (saved) return JSON.parse(saved);

    return [
        { id: "capacity", label: "Annual Production", value: "20000 Units/Mo", description: "Units" },
        { id: "craftsmen", label: "Skilled Craftsmen", value: "150+", description: "Artisans" },
        { id: "export", label: "Global Reach", value: "15+ Countries", description: "Established export network across Europe, Middle East, and North America." },
    ];
};

export const saveB2BStats = (stats: any) => {
    localStorage.setItem("abaseen_b2b_stats", JSON.stringify(stats));
};
